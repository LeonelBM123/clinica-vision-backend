...
class Paciente(models.Model):
    ...
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    agudeza_visual_derecho = models.CharField(max_length=20, blank=True)
    agudeza_visual_izquierdo = models.CharField(max_length=20, blank=True)
    presion_ocular_derecho = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    presion_ocular_izquierdo = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)

    def __str__(self):
        return f"{self.paciente.nombre}({self.numero_historia_clinica})"
